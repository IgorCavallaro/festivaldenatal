...
/* ---------------------------------------------------------
   SUPABASE CLIENT
   OBS: usamos "sb" (não "supabase") porque a biblioteca do
   Supabase já expõe um global chamado "supabase" — declarar
   const supabase = ... colidiria com ele.
--------------------------------------------------------- */
...
const sb = CONFIG_OK ? window.supabase.createClient(window.SUPABASE_CONFIG.url, window.SUPABASE_CONFIG.anonKey) : null;
...
function useTable(table) {
  ...
  useEffect(() => {
    ...
    const channel = sb.channel("rt_" + table).on("postgres_changes", {
      event: "*",
      schema: "public",
      table
    }, () => fetchAll()).subscribe();
...
/* ===========================================================
   ORÇAMENTOS
   Agora com: fornecedor, valor do frete, forma de pagamento
   (com parcelas + valor por parcela) e vínculo com um documento
   já cadastrado na aba Documentos.
=========================================================== */
const CATEGORIAS_ORCAMENTO = ["Decoração", "Gastronomia", "Artesãos", "Estrutura", "Divulgação", "Geral"];
const FORMAS_PAGAMENTO = ["Pix", "Boleto", "Cartão de Crédito", "Transferência", "Dinheiro", "Cheque", "Outro"];
...
function Orcamentos({
  ...
  const totalFrete = c.items.reduce((a, b) => a + Number(b.valor_frete || 0), 0);
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(PageHeader, {
    title: "Orçamentos",
    onHome: onHome,
    subtitle: "Valores previstos e realizados, fornecedor, frete, forma de pagamento e documento de referência de cada item."
  }), /*#__PURE__*/React.createElement(ErrBanner, {
    err: c.err
  }), /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-xs text-gray-500 mb-1"
  }, "Frete total"), /*#__PURE__*/React.createElement("p", {
    className: "text-lg font-bold text-gray-800"
  }, "R$ ", totalFrete.toLocaleString("pt-BR"))), /*#__PURE__*/React.createElement("div", {
    className: "bg-white border border-gray-200 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-500 mb-1"
    ...
    const doc = docById(i.documento_id);
    const totalParcelado = Number(i.parcelas || 1) * Number(i.valor_parcela || 0);
    return /*#__PURE__*/React.createElement("div", {
      key: i.id,
      className: "bg-white border border-gray-200 rounded-xl p-3.5"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-xs text-gray-500"
    }, i.categoria, i.fornecedor ? ` · Fornecedor: ${i.fornecedor}` : "", i.observacoes ? ` · ${i.observacoes}` : "")), /*#__PURE__*/React.createElement("div", {
      className: "flex items-center gap-2 shrink-0"
    }, /*#__PURE__*/React.createElement("select", {
      value: i.status,
      onChange: e => c.update(i.id, {
      ...
      className: "flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-gray-600 mb-2"
    }, /*#__PURE__*/React.createElement("span", null, "Previsto: ", /*#__PURE__*/React.createElement("strong", {
    ...
    })), Number(i.valor_frete) > 0 && /*#__PURE__*/React.createElement("span", null, "Frete: ", /*#__PURE__*/React.createElement("strong", {
      className: "text-gray-800"
    }, "R$ ", Number(i.valor_frete).toLocaleString("pt-BR")))), /*#__PURE__*/React.createElement("div", {
      className: "flex flex-wrap items-center gap-2"
    }, i.forma_pagamento && /*#__PURE__*/React.createElement("span", {
      className: "text-xs bg-gray-50 border border-gray-200 rounded-full px-2.5 py-1 text-gray-600"
    }, "💳 ", i.forma_pagamento, Number(i.parcelas) > 1 && ` · ${i.parcelas}x de R$ ${Number(i.valor_parcela).toLocaleString("pt-BR")}`, Number(i.parcelas) > 1 && totalParcelado > 0 && ` (total R$ ${totalParcelado.toLocaleString("pt-BR")})`), doc && /*#__PURE__*/React.createElement("a", {
      href: doc.url,
      target: "_blank",
      rel: "noreferrer",
      className: "text-xs bg-blue-50 border border-blue-200 rounded-full px-2.5 py-1 text-blue-700 hover:bg-blue-100"
    }, doc.tipo === "arquivo" ? "📄" : "🔗", " ", doc.titulo)));
  })), /*#__PURE__*/React.createElement("div", {
    className: "bg-white border border-gray-200 rounded-xl p-4"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-xs font-bold text-gray-500 uppercase tracking-wide mb-3"
    ...
    className: "border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white"
  }, FORMAS_PAGAMENTO.map(f => /*#__PURE__*/React.createElement("option", {
    key: f
    ...
    value: ""
  }, "Vincular documento (opcional)"), (documents || []).map(d => /*#__PURE__*/React.createElement("option", {
    key: d.id,
    value: d.id
    ...
    className: "border border-gray-200 rounded-lg px-3 py-2 text-sm"
  })), Number(form.parcelas) > 1 && Number(form.valor_parcela) > 0 && /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-gray-400 mb-2"
  }, "Total parcelado: R$ ", (Number(form.parcelas) * Number(form.valor_parcela)).toLocaleString("pt-BR")), /*#__PURE__*/React.createElement("input", {
...
function Documentos({
  ...
  const handleFile = async e => {
    ...
    try {
      ...
      const {
        data
      } = sb.storage.from("documentos").getPublicUrl(path);
      await c.insert({
